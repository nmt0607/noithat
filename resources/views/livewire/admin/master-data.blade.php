        ...
        <div class="p-2 pb-3 d-flex align-items-center justify-content-between">
            ...
            <div class="paginate">
                <div class="d-flex">
                    ...
                    <div class="">
                        <div class="disable">Quản lý cấu hình chung</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body p-2">
                <div class="widget-body">
                    <div class="widget-main">
                        <div class="row">
                            <div class="col-3" >
                            <label class="col-form-label">Loại cấu hình</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Loại cấu hình: {{$type}}</label><br>
                        </div>
                        <div class="form-group" {{$type == 'Giới thiệu'?'':'hidden'}}>
                            <label>Nội dung: </label>
                            <textarea  class="form-control" placeholder="Nội dung" wire:model.defer="content" rows="4"></textarea>
                        </div>
                        <div class="form-group row" {{$type == 'Banner'?'':'hidden'}}>
                            <div class="col-sm-12">
                                @livewire('component.files',[
                                'model_name' => \App\Models\MasterData::class,
                                'model_id' => $bannerId,
                                'folder' => 'jobs',
                                'admin_id'=>auth()->id(),
                                'canUpload'=>true,
...
<script>
    $("document").ready(() => {
        ...
        // $("#select_parent_id").select2({
        //     width: '100%'
        // })
        // $('#select_parent_id').on('change', function(e) {
        //     var data = $('#select_parent_id').select2("val");
